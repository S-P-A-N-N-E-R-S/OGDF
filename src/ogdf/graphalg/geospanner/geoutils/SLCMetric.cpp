/** \file
 * \brief Implementation of spherical law of cosines
 *
...
SLCMetric::SLCMetric(const GraphAttributes &graph)
    : m_GA(graph)
...
bool SLCMetric::preconditionsOk(const GraphAttributes &GA, std::string &error)
{
